...
* New packages : **rmarkdown** , **knitr** , (xtable , stargazer , pander , tables , ascii) , (ggrepel , viridis) , (RColorBrewer) , (ggthemes) , (revealjs , rmdshower/shower) , **flexdashboard** , (leaflet , dygraphs , DT , rthreejs , DiagrammeR) , **Shiny** , (bookdown , prettydoc , rticles) , (packrat , checkpoint)
